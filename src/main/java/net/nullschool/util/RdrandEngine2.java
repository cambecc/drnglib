 ...
 */
final class RdrandEngine2 extends DigitalRandomSpi {
    ...
    private synchronized static void link() throws IOException {  // TODO: sync on different object
        if (!isLinked) {
    ...
    static boolean linkAndCheckSupported() {
        ...
        try {
            ...
            // Generate a blob of randomness to check if the DRNG is operating correctly.
            // NativeMethods.rdrandBytes(new byte[8192], 10);
    ...
    RdrandEngine2() throws UnsupportedOperationException {
